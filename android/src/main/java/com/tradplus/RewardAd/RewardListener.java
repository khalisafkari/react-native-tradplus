...
public class RewardListener {
  ...
  public RewardListener(ReactApplicationContext context) {
    mContext = context;
  }
  ...
  public RewardAdListener rewardAdListener = new RewardAdListener() {
    @Override
  ...
  public RewardAdExListener rewardAdExListener = new RewardAdExListener() {
    @Override
    public void onAdAgainImpression(TPAdInfo tpAdInfo) {
      WritableMap map = Arguments.createMap();
      map.putMap("TPAdInfo", Utils.tpInfo(tpAdInfo));
      sendEvent("onAdAgainImpression", map);
    }
    ...
    public void onAdAgainVideoStart(TPAdInfo tpAdInfo) {
      WritableMap map = Arguments.createMap();
      map.putMap("TPAdInfo", Utils.tpInfo(tpAdInfo));
      sendEvent("onAdAgainVideoStart", map);
    }
    ...
    public void onAdAgainVideoEnd(TPAdInfo tpAdInfo) {
      WritableMap map = Arguments.createMap();
      map.putMap("TPAdInfo", Utils.tpInfo(tpAdInfo));
      sendEvent("onAdAgainVideoEnd", map);
    }
    ...
    public void onAdAgainVideoClicked(TPAdInfo tpAdInfo) {
      WritableMap map = Arguments.createMap();
      map.putMap("TPAdInfo", Utils.tpInfo(tpAdInfo));
      sendEvent("onAdAgainVideoClicked", map);
    }
    ...
    public void onAdPlayAgainReward(TPAdInfo tpAdInfo) {
      WritableMap map = Arguments.createMap();
      map.putMap("TPAdInfo", Utils.tpInfo(tpAdInfo));
      sendEvent("onAdPlayAgainReward", map);
    }
  };
